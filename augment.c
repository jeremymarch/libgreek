...
void augmentStem(VerbFormC *vf, UCS2 *ucs2, int *len, int bufferCapacity, bool decompose, int stem)
{
    if (decompose && (vf->verb->verbclass & PREFIXED) != PREFIXED)
    {
        ...
        {
            ucsplice(ucs2, len, bufferCapacity, 0, 2, (UCS2[]){GREEK_SMALL_LETTER_ETA_WITH_PSILI_AND_YPOGEGRAMMENI}, 1);
        ...
        if ((vf->tense == PLUPERFECT && vf->number == SINGULAR && utf8HasSuffix(vf->verb->present, "στημι")) || (vf->tense != PLUPERFECT && utf8HasSuffix(vf->verb->present, "στημι")) || !utf8HasSuffix(vf->verb->present, "στημι"))
        {
            ...
            ucsplice(ucs2, len, bufferCapacity, 0, 0, (UCS2[]){DECOMPOSED_AUGMENT_CHAR,SPACE,HYPHEN,SPACE}, 4);
        }
        return;
    }
    ...
    if ((vf->verb->verbclass & PREFIXED) == PREFIXED && !( utf8HasSuffix(vf->verb->present, "ἀποθνῄσκω") && vf->tense == PLUPERFECT) )
    {
        ...
        if (hasPrefix(ucs2, *len, upo, 3))
        {
            if ( decompose)
            {
                ucsplice(ucs2, len, bufferCapacity, 3, 0, (UCS2[]){SPACE,HYPHEN,SPACE,DECOMPOSED_AUGMENT_CHAR,SPACE,HYPHEN,SPACE}, 7);
            }
            else if (vf->tense == IMPERFECT || vf->tense == PLUPERFECT)
            {
                ucsplice(ucs2, len, bufferCapacity, 2, 1, (UCS2[]){GREEK_SMALL_LETTER_EPSILON}, 1);
            }
        }
        else if (hasPrefix(ucs2, *len, up, 2))
        {
            if ( decompose)
            {
                ucsplice(ucs2, len, bufferCapacity, 2, 0, (UCS2[]){GREEK_SMALL_LETTER_OMICRON, SPACE,HYPHEN,SPACE,DECOMPOSED_AUGMENT_CHAR,SPACE,HYPHEN,SPACE}, 8);
            }
            else if (vf->tense == IMPERFECT || vf->tense == PLUPERFECT)
            {
                ucsplice(ucs2, len, bufferCapacity, 2, 1, (UCS2[]){GREEK_SMALL_LETTER_ETA}, 1);
            }
        }
        else if (hasPrefix(ucs2, *len, para, 4))
        {
            if ( decompose)
            {
                ucsplice(ucs2, len, bufferCapacity, 4, 0, (UCS2[]){SPACE,HYPHEN,SPACE,DECOMPOSED_AUGMENT_CHAR,SPACE,HYPHEN,SPACE}, 7);
            }
            else if (vf->tense == IMPERFECT || vf->tense == PLUPERFECT)
            {
                ucsplice(ucs2, len, bufferCapacity, 3, 1, (UCS2[]){GREEK_SMALL_LETTER_EPSILON}, 1);
            }
        }
        else if (hasPrefix(ucs2, *len, pro, 3))
        {
            if ( decompose)
            {
                ucsplice(ucs2, len, bufferCapacity, 3, 0, (UCS2[]){SPACE,HYPHEN,SPACE}, 3);
                if (vf->tense == AORIST || vf->tense == IMPERFECT || vf->tense == PLUPERFECT)
                {
                    ucsplice(ucs2, len, bufferCapacity, 6, 0, (UCS2[]){DECOMPOSED_AUGMENT_CHAR,SPACE,HYPHEN,SPACE}, 4);
                }
            }
            else if (vf->tense == IMPERFECT || vf->tense == PLUPERFECT)
            {
                if (stem > 0)
                    ucsplice(ucs2, len, bufferCapacity, 3, 0, (UCS2[]){GREEK_SMALL_LETTER_UPSILON}, 1);
                else
                    ucsplice(ucs2, len, bufferCapacity, 3, 0, (UCS2[]){GREEK_SMALL_LETTER_EPSILON}, 1);
            }
        }
        else if (hasPrefix(ucs2, *len, ek, 2))
        {
            if ( decompose)
            {
                ucsplice(ucs2, len, bufferCapacity, 2, 0, (UCS2[]){SPACE,HYPHEN,SPACE}, 3);
                if (vf->tense == AORIST || vf->tense == IMPERFECT || vf->tense == PLUPERFECT)
                {
                    ucsplice(ucs2, len, bufferCapacity, 5, 0, (UCS2[]){DECOMPOSED_AUGMENT_CHAR,SPACE,HYPHEN,SPACE}, 4);
                }
            }
            else if (vf->tense == IMPERFECT || vf->tense == PLUPERFECT)
            {
                ucsplice(ucs2, len, bufferCapacity, 1, 1, (UCS2[]){GREEK_SMALL_LETTER_XI,GREEK_SMALL_LETTER_EPSILON}, 2);
            }
        }
        ...
        else if (hasPrefix(ucs2, *len, sum, 3))
        {
            if ( decompose)
            {
                ucsplice(ucs2, len, bufferCapacity, 2, 1, (UCS2[]){GREEK_SMALL_LETTER_NU,SPACE,HYPHEN,SPACE}, 4);
            ...
            {
                ucsplice(ucs2, len, bufferCapacity, 2, 1, (UCS2[]){GREEK_SMALL_LETTER_NU,GREEK_SMALL_LETTER_EPSILON}, 2);
            }
        }
        else if (hasPrefix(ucs2, *len, sun, 3))
        {
            if ( decompose)
            {
                ...
                {
                    ucsplice(ucs2, len, bufferCapacity, 8, 0, (UCS2[]){COMBINING_ROUGH_BREATHING}, 1);
                }
        ...
        {
            ucsplice(ucs2, len, bufferCapacity, 2, 0, (UCS2[]){GREEK_SMALL_LETTER_OMICRON,SPACE,HYPHEN,SPACE}, 4);
        }
        ...
        else if (hasPrefix(ucs2, *len, aph, 2))
        {
            if (decompose)
            {
                ucsplice(ucs2, len, bufferCapacity, 1, 1, (UCS2[]){GREEK_SMALL_LETTER_PI,GREEK_SMALL_LETTER_OMICRON,SPACE,HYPHEN,SPACE}, 5);
                ...
                if ((vf->tense == PLUPERFECT && vf->number == SINGULAR && utf8HasSuffix(vf->verb->present, "στημι")) || (vf->tense != PLUPERFECT && utf8HasSuffix(vf->verb->present, "στημι")) || (!utf8HasSuffix(vf->verb->present, "στημι") && !utf8HasSuffix(vf->verb->present, "ἀφῑ́ημι") && !(utf8HasSuffix(vf->verb->present, "ἀφικνέομαι") && vf->tense == PLUPERFECT)))
                {
                    ...
                    {
                        ucsplice(ucs2, len, bufferCapacity, 12, 0, (UCS2[]){COMBINING_ROUGH_BREATHING}, 1);
                    }
            ...
            else
            {
                ...
                {
                    ucsplice(ucs2, len, bufferCapacity, 2, 1, (UCS2[]){GREEK_SMALL_LETTER_EPSILON,GREEK_SMALL_LETTER_IOTA}, 2);
                }
                else if (ucs2[2] == GREEK_SMALL_LETTER_IOTA && ucs2[3] != COMBINING_MACRON)
                {
                    ucsplice(ucs2, len, bufferCapacity, 3, 0, (UCS2[]){COMBINING_MACRON}, 1);
                }
            }
        }
        ...
        else if (hasPrefix(ucs2, *len, kath, 3))
        {
            if (decompose)
            {
                ucsplice(ucs2, len, bufferCapacity, 2, 1, (UCS2[]){GREEK_SMALL_LETTER_TAU,GREEK_SMALL_LETTER_ALPHA, SPACE,HYPHEN,SPACE}, 5);
                ...
                {
                    ucsplice(ucs2, len, bufferCapacity, 7, 0, (UCS2[]){DECOMPOSED_AUGMENT_CHAR, SPACE,HYPHEN,SPACE}, 4);
            ...
            else
            {
                ...
                {
                    ucsplice(ucs2, len, bufferCapacity, 4, 0, (UCS2[]){COMBINING_MACRON}, 1);
                }
                //for histhmi pluperfect singular.  H&Q PAGE 378.
                else if (vf->tense == PLUPERFECT && (vf->number == SINGULAR || vf->voice != ACTIVE) && utf8HasSuffix(vf->verb->present, "στημι") )
                {
                    ucsplice(ucs2, len, bufferCapacity, 3, 1, (UCS2[]){GREEK_SMALL_LETTER_EPSILON,GREEK_SMALL_LETTER_IOTA}, 2);
                }
            }
        }
        else if (hasPrefix(ucs2, *len, metan, 5))
        {
            if (decompose)
            {
                ucsplice(ucs2, len, bufferCapacity, 3, 2, (UCS2[]){GREEK_SMALL_LETTER_ALPHA,SPACE,HYPHEN,SPACE,GREEK_SMALL_LETTER_ALPHA,GREEK_SMALL_LETTER_NU,GREEK_SMALL_LETTER_ALPHA,SPACE,HYPHEN,SPACE}, 10);
                ...
                {
                    ucsplice(ucs2, len, bufferCapacity, 13, 0, (UCS2[]){DECOMPOSED_AUGMENT_CHAR,SPACE,HYPHEN,SPACE}, 4);
            ...
            else
            {
                ...
                {
                    ucsplice(ucs2, len, bufferCapacity, 5, 1, (UCS2[]){GREEK_SMALL_LETTER_EPSILON,GREEK_SMALL_LETTER_IOTA}, 2);
                }
                else if (ucs2[5] == GREEK_SMALL_LETTER_IOTA)
                {
                    ucsplice(ucs2, len, bufferCapacity, 6, 0, (UCS2[]){COMBINING_MACRON}, 1);
                }
            }
        }
        else if (hasPrefix(ucs2, *len, epan, 4))
        {
            if (decompose)
            {
                ucsplice(ucs2, len, bufferCapacity, 2, 2, (UCS2[]){GREEK_SMALL_LETTER_IOTA,SPACE,HYPHEN,SPACE,GREEK_SMALL_LETTER_ALPHA,GREEK_SMALL_LETTER_NU,GREEK_SMALL_LETTER_ALPHA,SPACE,HYPHEN,SPACE}, 10);
                
                //isthmi only augments pluperfect in the singular
                if ((vf->tense == PLUPERFECT && vf->number == SINGULAR && utf8HasSuffix(vf->verb->present, "σταμαι")) || (vf->tense != PLUPERFECT && utf8HasSuffix(vf->verb->present, "σταμαι")))
                {
                    ucsplice(ucs2, len, bufferCapacity, 12, 0, (UCS2[]){DECOMPOSED_AUGMENT_CHAR,SPACE,HYPHEN,SPACE}, 4);
            ...
            else
            {
                ...
                if (vf->tense == PLUPERFECT && (vf->number == SINGULAR || vf->voice != ACTIVE) && utf8HasSuffix(vf->verb->present, "σταμαι") )
                {
                    ucsplice(ucs2, len, bufferCapacity, 4, 1, (UCS2[]){GREEK_SMALL_LETTER_EPSILON,GREEK_SMALL_LETTER_IOTA}, 2);
                }
                else if (ucs2[4] == GREEK_SMALL_LETTER_IOTA)
                {
                    ucsplice(ucs2, len, bufferCapacity, 5, 0, (UCS2[]){COMBINING_MACRON}, 1);
                }
            }
        }
    ...
    else if (ucs2[0] == GREEK_SMALL_LETTER_ALPHA)
    {
        ...
        {
            ucsplice(ucs2, len, bufferCapacity, 0, 2, (UCS2[]){GREEK_SMALL_LETTER_ETA_WITH_DASIA_AND_YPOGEGRAMMENI}, 1);
        }
    ...
    else if (ucs2[0] == GREEK_SMALL_LETTER_EPSILON_WITH_PSILI && vf->tense != PLUPERFECT)
    {
        ...
        {
            ucsplice(ucs2, len, bufferCapacity, 0, 1, (UCS2[]){GREEK_SMALL_LETTER_EPSILON,GREEK_SMALL_LETTER_IOTA_WITH_PSILI}, 2);
        }
        else
        {
            ucs2[0] = GREEK_SMALL_LETTER_ETA_WITH_PSILI;
    ...
    else if (ucs2[0] == GREEK_SMALL_LETTER_EPSILON_WITH_DASIA)
    {
        ...
        {
            ucsplice(ucs2, len, bufferCapacity, 0, 1, (UCS2[]){GREEK_SMALL_LETTER_EPSILON,GREEK_SMALL_LETTER_IOTA_WITH_DASIA}, 2);
        }
        else if (vf->tense == IMPERFECT)
        {
            ucsplice(ucs2, len, bufferCapacity, 0, 1, (UCS2[]){GREEK_SMALL_LETTER_EPSILON,GREEK_SMALL_LETTER_IOTA_WITH_DASIA}, 2);
    ...
    {
        ucsplice(ucs2, len, bufferCapacity, 0, 1, (UCS2[]){GREEK_SMALL_LETTER_IOTA,COMBINING_MACRON}, 2);
    }
    else if (ucs2[0] == GREEK_SMALL_LETTER_IOTA_WITH_PSILI)
    {
        ucsplice(ucs2, len, bufferCapacity, 0, 1, (UCS2[]){GREEK_SMALL_LETTER_IOTA,COMBINING_MACRON,COMBINING_SMOOTH_BREATHING}, 3);
    }
    else if (ucs2[0] == GREEK_SMALL_LETTER_IOTA_WITH_DASIA)
    {
        ucsplice(ucs2, len, bufferCapacity, 0, 1, (UCS2[]){GREEK_SMALL_LETTER_IOTA,COMBINING_MACRON,COMBINING_ROUGH_BREATHING}, 3);
    }
    else if (ucs2[0] == GREEK_SMALL_LETTER_OMICRON)
    {
        if (ucs2[1] == GREEK_SMALL_LETTER_IOTA_WITH_PSILI)
        {
            ucsplice(ucs2, len, bufferCapacity, 0, 1, (UCS2[]){GREEK_SMALL_LETTER_OMEGA_WITH_PSILI_AND_YPOGEGRAMMENI}, 1);
        }
        else if (ucs2[1] == GREEK_SMALL_LETTER_IOTA_WITH_DASIA)
        {
            ucsplice(ucs2, len, bufferCapacity, 0, 1, (UCS2[]){GREEK_SMALL_LETTER_OMEGA_WITH_DASIA_AND_YPOGEGRAMMENI}, 1);
        }
        else
        {
    ...
    {
        //h&q page 449
        ucsplice(ucs2, len, bufferCapacity, 0, 1, (UCS2[]){GREEK_SMALL_LETTER_EPSILON_WITH_DASIA,GREEK_SMALL_LETTER_OMEGA}, 2);
    }
    ...
    {
        ucsplice(ucs2, len, bufferCapacity, 0, 1, (UCS2[]){GREEK_SMALL_LETTER_UPSILON,COMBINING_MACRON}, 2);
    }
    else if (ucs2[0] == GREEK_SMALL_LETTER_UPSILON_WITH_PSILI)
    {
        ucsplice(ucs2, len, bufferCapacity, 0, 2, (UCS2[]){GREEK_SMALL_LETTER_UPSILON,COMBINING_MACRON,COMBINING_SMOOTH_BREATHING}, 3);
    }
    else if (ucs2[0] == GREEK_SMALL_LETTER_UPSILON_WITH_DASIA)
    {
        ucsplice(ucs2, len, bufferCapacity, 0, 2, (UCS2[]){GREEK_SMALL_LETTER_UPSILON,COMBINING_MACRON,COMBINING_ROUGH_BREATHING}, 3);
    }
    else if (isConsonant(ucs2[0]))
    {
        ucsplice(ucs2, len, bufferCapacity, 0, 0, (UCS2[]){GREEK_SMALL_LETTER_EPSILON_WITH_PSILI}, 1);
    }
}
...
void stripAugmentFromPrincipalPart(VerbFormC *vf, UCS2 *ucs2, int *len, int bufferCapacity, UCS2 presentStemInitial, bool decompose)
{
    ...
    if ((vf->verb->verbclass & PREFIXED) == PREFIXED)
    {
        ...
        if (hasPrefix(ucs2, *len, upe, 3))
        {
            if (decompose)
            {
                if (vf->tense == AORIST)
                {
                    ucsplice(ucs2, len, bufferCapacity, 2, 1, (UCS2[]){GREEK_SMALL_LETTER_OMICRON,SPACE,HYPHEN,SPACE}, 4);
            ...
            {
                ucsplice(ucs2, len, bufferCapacity, 2, 1, (UCS2[]){GREEK_SMALL_LETTER_OMICRON}, 1);
            }
        }
        else if (hasPrefix(ucs2, *len, up, 2))
        {
            if (decompose)
            {
                if (vf->tense == AORIST)
                {
                    ucsplice(ucs2, len, bufferCapacity, 2, 1, (UCS2[]){GREEK_SMALL_LETTER_OMICRON,SPACE,HYPHEN,SPACE,GREEK_SMALL_LETTER_ALPHA}, 5);
                    if (vf->mood == INDICATIVE)
                    {
                        ucsplice(ucs2, len, bufferCapacity, 6, 0, (UCS2[]){DECOMPOSED_AUGMENT_CHAR,SPACE,HYPHEN,SPACE}, 4);
                    }
            ...
            {
                ucsplice(ucs2, len, bufferCapacity, 2, 1, (UCS2[]){GREEK_SMALL_LETTER_ALPHA}, 1);
            }
        }
        else if (hasPrefix(ucs2, *len, par, 3))
        {
            if (decompose)
            {
                if (vf->tense == AORIST)
                {
                    ucsplice(ucs2, len, bufferCapacity, 3, 1, (UCS2[]){GREEK_SMALL_LETTER_ALPHA,SPACE,HYPHEN,SPACE}, 4);
                    if (vf->mood == INDICATIVE)
                    {
                        ucsplice(ucs2, len, bufferCapacity, 7, 0, (UCS2[]){DECOMPOSED_AUGMENT_CHAR,SPACE,HYPHEN,SPACE}, 4);
                    }
            ...
            {
                ucsplice(ucs2, len, bufferCapacity, 3, 1, (UCS2[]){GREEK_SMALL_LETTER_ALPHA}, 1);
            }
        }
        else if (hasPrefix(ucs2, *len, pro, 3))
        {
            if (decompose)
            {
                if (vf->tense == AORIST)
                {
                    ucsplice(ucs2, len, bufferCapacity, 3, 1, (UCS2[]){SPACE,HYPHEN,SPACE}, 3);
                    if (vf->mood == INDICATIVE)
                    {
                        ucsplice(ucs2, len, bufferCapacity, 6, 0, (UCS2[]){DECOMPOSED_AUGMENT_CHAR,SPACE,HYPHEN,SPACE}, 4);
                    }
        ...
        else if (hasPrefix(ucs2, *len, ex, 2))
        {
            if (decompose)
            {
                if (vf->tense == AORIST)
                {
                    ucsplice(ucs2, len, bufferCapacity, 1, 1, (UCS2[]){GREEK_SMALL_LETTER_KAPPA,SPACE,HYPHEN,SPACE}, 4);
                    if (vf->mood == INDICATIVE)
                    {
                        ucsplice(ucs2, len, bufferCapacity, 5, 1, (UCS2[]){DECOMPOSED_AUGMENT_CHAR,SPACE,HYPHEN,SPACE}, 4);
                    }
                    else
                    {
                        ucsplice(ucs2, len, bufferCapacity, 5, 1, NULL, 0);
                    }
                }
            }
            else if ((vf->tense == AORIST && vf->mood != INDICATIVE) || vf->tense == FUTURE)
            {
                ucsplice(ucs2, len, bufferCapacity, 1, 2, (UCS2[]){GREEK_SMALL_LETTER_KAPPA}, 1);
            }
        }
        else if (hasPrefix(ucs2, *len, ane, 3))
        {
            if (decompose)
            {
                if (vf->tense == AORIST)
                {
                    ucsplice(ucs2, len, bufferCapacity, 2, 1, (UCS2[]){GREEK_SMALL_LETTER_ALPHA,SPACE,HYPHEN,SPACE}, 4);
                    if (vf->mood == INDICATIVE)
                    {
                        ucsplice(ucs2, len, bufferCapacity, 6, 0, (UCS2[]){DECOMPOSED_AUGMENT_CHAR,SPACE,HYPHEN,SPACE}, 4);
                    }
        ...
        else if (hasPrefix(ucs2, *len, anh, 3))
        {
            if (decompose)
            {
                if (vf->tense == AORIST)
                {
                    ucsplice(ucs2, len, bufferCapacity, 2, 1, (UCS2[]){GREEK_SMALL_LETTER_ALPHA,SPACE,HYPHEN,SPACE,GREEK_SMALL_LETTER_EPSILON}, 5);
                    if (vf->mood == INDICATIVE)
                    {
                        ucsplice(ucs2, len, bufferCapacity, 6, 0, (UCS2[]){DECOMPOSED_AUGMENT_CHAR,SPACE,HYPHEN,SPACE }, 4);
                    }
        ...
        else if (hasPrefix(ucs2, *len, sum, 3))
        {
            if (decompose)
            {
                if (vf->tense == AORIST)
                {
                    ...
                    if (vf->mood == INDICATIVE)
                    {
                        ucsplice(ucs2, len, bufferCapacity, 6, 0, (UCS2[]){DECOMPOSED_AUGMENT_CHAR,SPACE,HYPHEN,SPACE,GREEK_SMALL_LETTER_EPSILON}, 5);
                    }
                    else if (vf->tense == AORIST || vf->tense == FUTURE)
                    {
                        ucs2[6] = GREEK_SMALL_LETTER_EPSILON;
        ...
        else if (hasPrefix(ucs2, *len, sun, 3))
        {
            if (decompose)
            {
                if (vf->tense == AORIST)
                {
                    ...
                    {
                        ucsplice(ucs2, len, bufferCapacity, 6, 1, (UCS2[]){DECOMPOSED_AUGMENT_CHAR,SPACE,HYPHEN,SPACE}, 4);
                    }
                    ...
                    {
                        ucsplice(ucs2, len, bufferCapacity, 6, 1, (UCS2[]){DECOMPOSED_AUGMENT_CHAR,SPACE,HYPHEN,SPACE,GREEK_SMALL_LETTER_EPSILON}, 5);
                        
                        if (ucs2[10] == GREEK_SMALL_LETTER_EPSILON && ucs2[11] == GREEK_SMALL_LETTER_IOTA && vf->voice == PASSIVE)
                        {
                            ucsplice(ucs2, len, bufferCapacity, 10, 2, (UCS2[]){GREEK_SMALL_LETTER_EPSILON_WITH_DASIA}, 1);
                        }
                    }
                    else if (ucs2[6] == GREEK_SMALL_LETTER_EPSILON && ucs2[7] == GREEK_SMALL_LETTER_IOTA) //sunihmi
                    {
                        ucsplice(ucs2, len, bufferCapacity, 6, 2, (UCS2[]){GREEK_SMALL_LETTER_EPSILON_WITH_DASIA}, 1);
                    }
                    ...
                    {
                        ucsplice(ucs2, len, bufferCapacity, 6, 1, NULL, 0); //remove augment
                    }
                }
                else
                {
            ...
            else if ((vf->tense == AORIST && vf->mood != INDICATIVE) || vf->tense == FUTURE)
            {
                ...
                {
                    ucsplice(ucs2, len, bufferCapacity, 4, 1, NULL, 0);
                }
                ...
                {
                    ucsplice(ucs2, len, bufferCapacity, 2, 2, (UCS2[]){GREEK_SMALL_LETTER_MU}, 1);
                }
                else
                {
                    ucsplice(ucs2, len, bufferCapacity, 3, 1, NULL, 0);
        ...
        else if (hasPrefix(ucs2, *len, dih, 3))
        {
            if (decompose)
            {
                ...
                {
                    ucsplice(ucs2, len, bufferCapacity, 6, 0, (UCS2[]){GREEK_SMALL_LETTER_EPSILON}, 1);
                }
            }
            else
            {
        ...
        else if (hasPrefix(ucs2, *len, apw, 3))
        {
            if (decompose)
            {
                ...
                if (vf->tense == AORIST && vf->mood == INDICATIVE)
                {
                    ucsplice(ucs2, len, bufferCapacity, 6, 1, (UCS2[]){DECOMPOSED_AUGMENT_CHAR,SPACE,HYPHEN,SPACE,GREEK_SMALL_LETTER_OMICRON}, 5);
                }
                else
                {
        ...
        else if (hasPrefix(ucs2, *len, aph, 2))
        {
            if (decompose)
            {
                ...
                if (vf->tense == AORIST && vf->mood == INDICATIVE && !(ucs2[6] == GREEK_SMALL_LETTER_ETA && ucs2[7] == GREEK_SMALL_LETTER_KAPPA && (vf->number == SINGULAR || vf->voice != ACTIVE)))
                {
                    ...
                    {//ikneomai
                        ucsplice(ucs2, len, bufferCapacity, 10, 2, (UCS2[]){GREEK_SMALL_LETTER_IOTA_WITH_DASIA}, 1);
                    }
                }
                else if (ucs2[6] == GREEK_SMALL_LETTER_EPSILON && ucs2[7] == GREEK_SMALL_LETTER_IOTA)
                {
                ...
                {   //ikneomai
                    ...
                    ucsplice(ucs2, len, bufferCapacity, 6, 2, (UCS2[]){GREEK_SMALL_LETTER_IOTA_WITH_DASIA}, 1);
                }
        ...
        else if (hasPrefix(ucs2, *len, metan, 5))
        {
            if (decompose)
            {
                ucsplice(ucs2, len, bufferCapacity, 3, 3, (UCS2[]){GREEK_SMALL_LETTER_ALPHA,SPACE,HYPHEN,SPACE,GREEK_SMALL_LETTER_ALPHA,GREEK_SMALL_LETTER_NU,GREEK_SMALL_LETTER_ALPHA,SPACE,HYPHEN,SPACE}, 10);
        ...
        else if (hasPrefix(ucs2, *len, epan, 4))
        {
            if (decompose)
            {
                ucsplice(ucs2, len, bufferCapacity, 2, 3, (UCS2[]){GREEK_SMALL_LETTER_IOTA,SPACE,HYPHEN,SPACE,GREEK_SMALL_LETTER_ALPHA,GREEK_SMALL_LETTER_NU,GREEK_SMALL_LETTER_ALPHA,SPACE,HYPHEN,SPACE}, 10);
        ...
        else if (hasPrefix(ucs2, *len, ep, 2))
        {
            if (decompose)
            {
                ucsplice(ucs2, len, bufferCapacity, 2, 1, (UCS2[]){GREEK_SMALL_LETTER_IOTA,SPACE,HYPHEN,SPACE}, 4);
        ...
        else if (hasPrefix(ucs2, *len, meta, 4))
        {
            if (decompose)
            {
                ucsplice(ucs2, len, bufferCapacity, 4, 0, (UCS2[]){SPACE,HYPHEN,SPACE}, 3);
    ...
    else if (vf->tense == AORIST)//removing this because of decompose option.  we already check these things before this is called. && (mood == SUBJUNCTIVE || mood == OPTATIVE || mood == IMPERATIVE))
    {
        if (ucs2[0] == '-')
        {
            ...
            {
                ucsplice(ucs2, len, bufferCapacity, 1, 2, (UCS2[]){GREEK_SMALL_LETTER_EPSILON_WITH_DASIA}, 1);
            }
            else if (ucs2[1] != GREEK_SMALL_LETTER_ETA_WITH_DASIA)
            {
                ucsplice(ucs2, len, bufferCapacity, 1, 1, NULL, 0);
            }
        }
        else if (ucs2[0] == GREEK_SMALL_LETTER_EPSILON && ucs2[1] == GREEK_SMALL_LETTER_IOTA_WITH_DASIA) //ei(
        {
            ucsplice(ucs2, len, bufferCapacity, 0, 2, (UCS2[]){GREEK_SMALL_LETTER_EPSILON_WITH_DASIA}, 1);
        }
        ...
        {
            ucsplice(ucs2, len, bufferCapacity, 0, 1, NULL, 0);
        }
        else if (hasPrefix(ucs2, *len, err, 3)) //err
        {
            ucsplice(ucs2, len, bufferCapacity, 0, 3, (UCS2[]){GREEK_SMALL_LETTER_RHO_WITH_DASIA}, 1);
        }
        ...
        {
            ucsplice(ucs2, len, bufferCapacity, 0, 1, (UCS2[]){GREEK_SMALL_LETTER_ALPHA,GREEK_SMALL_LETTER_IOTA_WITH_DASIA}, 2);
        }
        else if (ucs2[0] == GREEK_SMALL_LETTER_ETA_WITH_PSILI_AND_YPOGEGRAMMENI) //hi)
        {
            ucsplice(ucs2, len, bufferCapacity, 0, 1, (UCS2[]){GREEK_SMALL_LETTER_ALPHA,GREEK_SMALL_LETTER_IOTA_WITH_PSILI}, 2);
        }
    ...
    if (vf->tense == AORIST && vf->mood == INDICATIVE && decompose && (vf->verb->verbclass & PREFIXED) != PREFIXED)
    {
        if (ucs2[0] == '-')
        {
            ...
            ucsplice(ucs2, len, bufferCapacity, 1, 0, (UCS2[]){SPACE,DECOMPOSED_AUGMENT_CHAR,SPACE,HYPHEN,SPACE}, 5);
        }
        else
        {
            if (ucs2[0] == GREEK_SMALL_LETTER_ETA_WITH_DASIA)
...
void decomposePrefixes(VerbFormC *vf, UCS2 *ucs2, int *len, int bufferCapacity)
{
    ...
    {
        ucsplice(ucs2, len, bufferCapacity, 2, 0, (UCS2[]){GREEK_SMALL_LETTER_ALPHA,SPACE,HYPHEN,SPACE}, 4);
    }
    else if (hasPrefix(ucs2, *len, sum, 3))
    {
        ucsplice(ucs2, len, bufferCapacity, 2, 1, (UCS2[]){GREEK_SMALL_LETTER_NU,SPACE,HYPHEN,SPACE}, 4);
    ...
    else if (hasPrefix(ucs2, *len, aph, 2))
    {
        ...
        {
            ucsplice(ucs2, len, bufferCapacity, 6, 1, (UCS2[]){GREEK_SMALL_LETTER_EPSILON_WITH_DASIA}, 1);
        }
        else if (ucs2[6] == GREEK_SMALL_LETTER_EPSILON)
        {
            ucs2[6] = GREEK_SMALL_LETTER_EPSILON_WITH_DASIA;
    ...
    else if (hasPrefix(ucs2, *len, metan, 5))
    {
        ...
        {
            ucsplice(ucs2, len, bufferCapacity, 13, 0, (UCS2[]){GREEK_SMALL_LETTER_IOTA_WITH_DASIA}, 1);
        }
        else if (firstNonPrefixLetter == GREEK_SMALL_LETTER_EPSILON)
        {
            ucsplice(ucs2, len, bufferCapacity, 13, 0, (UCS2[]){GREEK_SMALL_LETTER_EPSILON_WITH_DASIA}, 1);
        }
    }
    else if (hasPrefix(ucs2, *len, epan, 4))
    {
        ...
        if (firstNonPrefixLetter == GREEK_SMALL_LETTER_IOTA)
        {
            ucsplice(ucs2, len, bufferCapacity, 12, 0, (UCS2[]){GREEK_SMALL_LETTER_IOTA_WITH_DASIA}, 1);
        }
        else if (firstNonPrefixLetter == GREEK_SMALL_LETTER_EPSILON)
        {
            ucsplice(ucs2, len, bufferCapacity, 12, 0, (UCS2[]){GREEK_SMALL_LETTER_EPSILON_WITH_DASIA}, 1);
        }
    }
    else if (hasPrefix(ucs2, *len, meta, 4))
    {
